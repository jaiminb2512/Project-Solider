...
const eventsData: HistoricalEvent[] = [
  ...
  {
    id: 3,
    title: "Discovery of Kanha National Park",
    description:
      "Kanha National Park, located near Jabalpur, India, was established as a tiger reserve in 1974.",
    position: [23.1781, 79.9166],
    category: "Nature",
  },
  // Politics
  {
