        ...
        <Nav>
            <div className={menuIcon ? "navbar active" : "navbar"}>
                <ul className="navbar-lists">
                    ...
                    <li><NavLink to="/cart" className="navbar-link cart-trolley--link" >
                ...
                <div className="mobile-navbar-btn">
                    ...
                    <CgClose name="menu-outline" className="mobile-nav-icon close-outline" onClick={() => setMenuIcon(false)}></CgClose>
                </div>
            </div>
        </Nav>
    );
