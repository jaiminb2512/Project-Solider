  ...
  return (
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:+022 5454 5252">+91 1234567890</a>
            </li>
            <li>
              <a href="tel:+022 2326 6232">+91 1234567899</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        <p>Project By jaimin Prajapati</p>
    
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/jaimin-prajapati-25122003-jp/"
              title="LinkedIn"
              target="_blank"
